...
Remarque: changement du fichier requirements.txt: Flask/Werkzeug incompatibles avec Python 3.14 => solution: Mise à jour vers Flask 3.1.3 + Werkzeug 3.1.8

1. Finalement, on démarre l'application Python/Flask
